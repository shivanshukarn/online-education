    ...
    <section className="text-gray-600 body-font" id='Services'>
      <div className="container px-5 py-14 mx-auto">
        <div className="text-center mb-20">
          ...
          <p className="text-sm leading-relaxed xl:w-2/4 lg:w-3/4 mx-auto text-gray-500s">Blue bottle crucifix vinyl post-ironic four dollar toast vegan taxidermy. Gastropub indxgo juice poutine, ramps microdosing banh mi pug.</p>
