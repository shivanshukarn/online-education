      ...
      <div className="container px-5 py-14 mx-auto">
        ...
        <div className="lg:w-1/2 md:w-2/3 mx-auto">
          <div className="flex flex-wrap -m-2">
            ...
            <div className="p-2 w-full">
              <button className="flex mx-auto text-white py-2 px-8 focus:outline-none rounded text-lg bg-[#18164d] border-2 hover:bg-gray-200 hover:text-[#18164d] font-semibold hover:border-[#18164d] hover:border-2">Button</button>
            </div>
            <div className="p-2 w-full pt-8 mt-8 border-t border-gray-200 text-center">
              <a className="text-[#18164d]">example@email.com</a>
